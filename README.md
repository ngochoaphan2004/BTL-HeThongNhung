...
A comprehensive embedded system for monitoring IoT sensors, plant management, and real-time analytics, consisting of a backend API and a React-based frontend.

## Backend (Embedded Backend)

Backend của hệ thống **nhúng** sử dụng **Firebase Functions + Express + Swagger UI** để quản lý dữ liệu cảm biến và giám sát hệ thống nhúng.
...
- `src/components/`: Reusable UI components (Header, Sidebar, Charts, etc.)
- `src/pages/`: Main application pages (Analytics, Plant Management)
- `src/services/`: API services and global context
